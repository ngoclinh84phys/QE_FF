...
SUBROUTINE iosys_ff()
  ...
  !
  USE finite_field_mod,  ONLY : finite_field_pert_ => finite_field_pert, &  ! NLN
                                    overlap_thr_ => overlap_thr, &          ! NLN
                                    orb_index_i_ => orb_index_i, &          ! NLN
                                    orb_index_j_ => orb_index_j, &          ! NLN
                                    l_ff_bse, l_ff_kc                       ! NLN
  USE kc_mod,            ONLY : use_wannier_orbs_ => use_wannier_orbs       ! NLN
  !
  ! ... CONTROL namelist
  !
  ...
  !
  USE input_parameters, ONLY : finite_field_pert, finite_field_bse,&  ! NLN
                               finite_field_kc,  use_wannier_orbs, &  ! NLN
                               overlap_thr, orb_index_i, orb_index_j  ! NLN  
  ! 
...
!!!!  
  ...
  !
  ! ... Finite field pertubation method for BSE  
  !
  finite_field_pert_ = finite_field_pert ! NLN
  use_wannier_orbs_  = use_wannier_orbs  ! NLN
  overlap_thr_       = overlap_thr       ! NLN
  orb_index_i_       = orb_index_i       ! NLN
  orb_index_j_       = orb_index_j       ! NLN
  !
  IF (finite_field_bse) l_ff_bse = .TRUE.! NLN 
  IF (finite_field_kc)  l_ff_kc  = .TRUE.! NLN 
  !
