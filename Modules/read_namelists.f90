...
!=======================================================================
     ...
     SUBROUTINE electrons_bcast()
       ...
       !
       !
       ! ... finite field pertubation method
       CALL mp_bcast( finite_field_pert,     ionode_id, intra_image_comm )  ! NLN 
       CALL mp_bcast( finite_field_kc,       ionode_id, intra_image_comm )  ! NLN 
       CALL mp_bcast( finite_field_bse,      ionode_id, intra_image_comm )  ! NLN 
       CALL mp_bcast( use_wannier_orbs,      ionode_id, intra_image_comm )  ! NLN
       CALL mp_bcast( overlap_thr,           ionode_id, intra_image_comm )  ! NLN
       CALL mp_bcast( orb_index_i,           ionode_id, intra_image_comm )  ! NLN
       CALL mp_bcast( orb_index_j,           ionode_id, intra_image_comm )  ! NLN
       !
       RETURN
       !
     END SUBROUTINE
