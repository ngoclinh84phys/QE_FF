...
!=----------------------------------------------------------------------------=!
      ...
      USE electrons_module,  ONLY : print_eigenvalues, print_centers_spreads
      USE emptystates_electrons_module, ONLY : emptystates_print_eigenvalues, emptystates_print_centers_spreads 
   ...
   !
      ...
      IF( ionode ) THEN
         ...
         IF( tprint ) THEN
            ...
            CALL emptystates_print_eigenvalues ()
            CALL print_centers_spreads( 31, tfile, tstdout, nfi, tps )
            CALL emptystates_print_centers_spreads ( )
            !KOOPMANS COMPLIANT FUNCTIONALS  
            !
