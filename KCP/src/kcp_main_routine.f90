...
!
!----------------------------------------------------------------------------
SUBROUTINE kcp_main_routine( tau_out, fion_out, etot_out )
  !----------------------------------------------------------------------------
  !
  USE kinds,                    ONLY : DP
...
444  IF ( tfor ) THEN
     ...
     IF ( .NOT.tnosep .OR. CYCLE_NOSE.EQ.2 ) THEN
        ...
        ENDIF
        !
     ENDIF !(.NOT.tnosep.OR.CYCLE_NOSE.EQ.2)
     !
     !--------------------------------------------------------------------------
  ...
  RETURN
  !
END SUBROUTINE kcp_main_routine 
!
!----------------------------------------------------------------------------
SUBROUTINE kcp_terminate_run()
  !----------------------------------------------------------------------------
  !
...
!==============================================================
  ...
  CALL mp_report()
  !
ENDSUBROUTINE kcp_terminate_run
